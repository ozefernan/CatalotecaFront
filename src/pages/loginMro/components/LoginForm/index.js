                      ...
                      <div className="b-conteudo-item-mro">
                        <Form className="form">
                          ...
                          <div className="checkbox">
                            <label type="checkbox">
                              <Form.Check type="checkbox" label="Lembrar meu login" /></label>
                            <a name="LembrarLogin" className="btn btn-link pull-right no-padding-top no-margin-top" herf="#">Esqueci minha senha</a>
                          </div>
                          <Button variant="" className="btn btn-default btn-lg btn-block" type="submit">
                            Entrar
                          </Button>
                        </Form>
                        <div className="b-item-mro-cadastre-se">
                          ...
                          <a className="btn btn-default btn-lg btn-traco pull-right no-margin-top">Cadastre-se</a>
                        </div>
                      </div>
                    </Col>
                  </Row>
                  ...
                  <Col md={{span:10 ,offset: 1}}>
                    <div className="s-padrao">
                      ...
                      <div className="item-distribuidor-b-conteudo">
                        ...
                        <a className="btn btn-lg btn-default btn-outline" href="/admin/login">Login</a>
                        <div className="b-item-distribuidor-cadastre-se">
                          <p className="traco-texto">ou</p>
                          <h4 className="h4">Quero cadastrar minha empresa</h4>
                          <a className="btn btn-default btn-lg" href="#">Cadastre-se</a>
                        </div>
                      </div>
                    </div>
                  </Col>
